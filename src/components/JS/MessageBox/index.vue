<template>
  <div class="messageBox">
    ...
    <p>{{content}}</p>
    <div>
      <div v-if="cancel" @touchstart='handleCanel'>{{cancel}}</div>
...
<style scoped>
.messageBox{width: 200px;height: 120px;border: 1px #ccc solid;border-radius: 4px;background: white; box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;top:50%;transform: translate(-50%,-50%);}
