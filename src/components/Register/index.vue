<template>
  <div class="register_body">
    ...
    <div>
      确认密码: <input v-model="spassword" class="register_text" type="password">
    </div>
    <div>
...
.register_body .register_email button{position: absolute; right: 10px; top: 10px; height: 30px; border-radius: 3px; border:none; background: #e54847; padding: 5px;}
